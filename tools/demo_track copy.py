...
def image_demo(predictor, vis_folder, current_time, args):
    ...
    files.sort()
    logger.info(
        "Tracker params (image_demo): track_thresh=%.4f, track_buffer=%d, match_thresh=%.4f, fps=%d",
        args.track_thresh,
        args.track_buffer,
        args.match_thresh,
        args.fps,
...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    logger.info(
        "Tracker params (imageflow_demo): track_thresh=%.4f, track_buffer=%d, match_thresh=%.4f, frame_rate=%.2f",
        args.track_thresh,
        args.track_buffer,
        args.match_thresh,
        fps,
...
def main(exp, args):
    ...
    logger.info(
        "Effective params: conf=%.4f, nms=%.4f, track_thresh=%.4f, match_thresh=%.4f, track_buffer=%d",
        exp.test_conf,
        exp.nmsthre,
        args.track_thresh,
        args.match_thresh,
